...
const Nav = () => {
  return (
    <div className="section-nav flex fixed w-full justify-between items-center h-20 bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg z-50">
      ...
      <div className="mr-10">
        <a href="#contact" className="bg-custom-pink hover:bg-pink-600 text-white py-2 px-4 font-bold rounded-full shadow-lg hover:shadow-2xl transition-shadow duration-300">
          Agenda una consulta
        </a>
      </div>
    </div>
